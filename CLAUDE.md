...
- The README is user-facing setup documentation; when changing `docker-compose.yml` or the Unbound configs, update the corresponding README section (and note that the sibling `pihole-docs` repo documents this setup too).
